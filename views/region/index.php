...
$baseViewUrl = Url::to(['region/view']);
$baseUpdateUrl = Url::to(['region/update']);
$baseDeleteUrl = Url::to(['region/delete']);
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
                    <div class="input-group w-auto input-group-flat">
                        ...
                        <input type="text" class="form-control form-control-sm" id="region-search" placeholder="Buscar...">
                    </div>
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_region"><i class="ti ti-plus me-1"></i>Agregar Nueva</a>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#region-search').on('keyup', function() {
