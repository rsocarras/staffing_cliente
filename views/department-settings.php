                                ...
                                <div class="card flex-fill mb-0 bg-soft-light border shadow-none">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                                            ...
                                            <li class="nav-item">
                                                <a href="department-settings" class="nav-link active">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_department"><i class="ti ti-plus me-1"></i>Add New</a>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-nowrap bg-white border mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-medium text-dark">Human Resources</td>
                                                        <td>25 Nov 2025</td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Finance & Accounts</td>
                                                        <td>24 Sep 2025</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Networking</td>
                                                        <td>21 Jul 2025</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Testing</td>
                                                        <td>15 Mar 2025</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Operations</td>
                                                        <td>16 Feb 2025</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Customer Support / Service</td>
                                                        <td>20 Jan 2025</td>
