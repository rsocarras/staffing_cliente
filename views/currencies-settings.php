                                ...
                                <div class="card flex-fill mb-0 bg-soft-light border shadow-none">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                                            ...
                                            <li class="nav-item">
                                                <a href="currencies-settings" class="nav-link active">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_currency"><i class="ti ti-plus me-1"></i>Add New</a>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-nowrap bg-white border mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-medium text-dark">US Dollar<span class="badge ms-2 badge-soft-primary">Base Currency</span></td>
                                                        <td>USD</td>
                                                        <td>$</td>
                                                        <td>1.0</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit_currency"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#delete_currency"><i class="ti ti-trash me-2"></i>Delete</a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-medium text-dark">Dhirams</td>
                                                        <td>AED</td>
                                                        <td>د.إ</td>
                                                        <td>3.67</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Rupee</td>
                                                        <td>INR</td>
                                                        <td>₹</td>
                                                        <td>86.62</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Pound</td>
                                                        <td>GBP</td>
                                                        <td>£</td>
                                                        <td>0.81</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Euro</td>
                                                        <td>EUR</td>
                                                        <td>€</td>
                                                        <td>0.96</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Japanese Yen</td>
                                                        <td>JPY</td>
                                                        <td>¥</td>
                                                        <td>0.96</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
