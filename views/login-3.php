                ...
                <div class="col-xl-5 col-md-6 col-sm-10 mx-auto">
                    ...
                    <form action="index">
                        <div class="d-flex flex-column justify-content-between p-3">
                            ...
                            <div class="card mb-0 login-item">
                                <div class="card-body p-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        ...
                                        <div class="text-end">
                                            <a href="forgot-password-3" class="forgot-password">Forgot Password?</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center mt-3">
                                        <p class="fw-normal mb-0">Don’t have an account?
                                            <a href="register-3" class="text-dark text-decoration-underline "> Create Account</a>
                                        </p>
                                    </div>
