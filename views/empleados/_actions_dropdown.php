...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end">
        ...
        <li><a href="javascript:void(0);" class="dropdown-item btn-empleado-edit d-flex align-items-center gap-2 py-2 rounded text-primary" data-user-id="<?= (int) $model->user_id ?>"><span class="avatar avatar-sm bg-soft-primary text-primary rounded-circle d-inline-flex align-items-center justify-content-center flex-shrink-0"><i class="ti ti-edit fs-12"></i></span><span class="fw-medium">Editar</span></a></li>
    </ul>
</div>
