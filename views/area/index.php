                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 d-flex">
                        <div class="card mb-0 flex-fill shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div>
                                    <p class="mb-0 text-muted fs-13">Total áreas</p>
                        ...
                        <div class="card mb-0 flex-fill shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="avatar avatar-lg rounded-circle bg-success flex-shrink-0 me-3">
                                    <span class="avatar-title text-white"><i class="ti ti-hierarchy-2 fs-22"></i></span>
                                </div>
                                <div>
                                    <p class="mb-0 text-muted fs-13">Raíces</p>
                                    <h4 class="mb-0 fw-bold"><?= (int) ($summaryCounts['raices'] ?? 0) ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card mb-0 flex-fill shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="avatar avatar-lg rounded-circle bg-primary flex-shrink-0 me-3">
                                    <span class="avatar-title text-white"><i class="ti ti-hierarchy fs-22"></i></span>
                                </div>
                                <div>
                                    <p class="mb-0 text-muted fs-13">Subáreas</p>
                                    <h4 class="mb-0 fw-bold"><?= (int) ($summaryCounts['subareas'] ?? 0) ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="modal-view-area">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-0" id="modal-view-area-body">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-area-view', function() {
        ...
        $('#modal-view-area-body').html('<div class="text-center py-5 px-3"><span class="spinner-border text-primary"></span><p class="text-muted mt-2 mb-0">Cargando...</p></div>');
        modal.show();
        $.get('{$viewAjaxUrl}', { id: id }, function(html) {
            $('#modal-view-area-body').html(html);
        }).fail(function() {
            $('#modal-view-area-body').html('<div class="alert alert-danger border-0 m-3">Error al cargar los datos.</div>');
        });
    });
