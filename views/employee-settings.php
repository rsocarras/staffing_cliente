                                ...
                                <div class="card flex-fill mb-0 bg-soft-light border shadow-none">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                                            ...
                                            <li class="nav-item">
                                                <a href="employee-settings" class="nav-link active">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_employee"><i class="ti ti-plus me-1"></i>Add New</a>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-nowrap bg-white border mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-medium text-dark">Administrator</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit_employee_type"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#delete_employee_type"><i class="ti ti-trash me-2"></i>Delete</a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-medium text-dark">Consultant</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                                <i class="ti ti-dots-vertical fs-16 text-dark" aria-hidden="true"></i>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Contractor</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                                <i class="ti ti-dots-vertical fs-16 text-dark" aria-hidden="true"></i>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Full Time</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                                <i class="ti ti-dots-vertical fs-16 text-dark" aria-hidden="true"></i>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Part Time</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                                <i class="ti ti-dots-vertical fs-16 text-dark" aria-hidden="true"></i>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Intern</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                                <i class="ti ti-dots-vertical fs-16 text-dark" aria-hidden="true"></i>
