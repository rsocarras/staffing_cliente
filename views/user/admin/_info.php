...
<table class="table">
    ...
    <tr>
        ...
        <td class="text-success"><?= Yii::t('usuario', 'Confirmed at {0, date, MMMM dd, YYYY HH:mm}', [$user->confirmed_at]) ?></td>
        <?php else: ?>
    ...
    <tr>
        ...
        <td class="text-danger"><?= Yii::t('usuario', 'Blocked at {0, date, MMMM dd, YYYY HH:mm}', [$user->blocked_at]) ?></td>
        <?php else: ?>
