...
<?php if ($page == 'add-invoice' || $page == 'appearance-settings' || $page == 'clients-grid' || $page == 'clients' || $page == 'company-settings' || $page == 'edit-invoice' || $page == 'edit-user' || $page == 'employee-settings' || $page == 'free-trial-2' || $page == 'free-trial-3' || $page == 'free-trial' || $page == 'invoice-details' || $page == 'location-settings' || $page == 'plans-and-billings' || $page == 'plugin' || $page == 'profile' || $page == 'profile-settings' || $page == 'security-settings' || $page == 'user-profile-settings' || $page == 'user-security-settings') {   ?>
    <!-- intel input -->
...
<link rel="stylesheet" href="<?= Url::to('@web/assets/css/custom-theme.css') ?>">