        ...
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                ...
                <ul class="d-flex align-items-center flex-shrink-0 list-unstyled mb-0">
                    <li>
                        <a href="contacts" class="btn btn-icon btn-sm bg-primary text-white active me-2" aria-label="Grid View"><i class="ti ti-layout-grid"></i></a>
                    </li>
                    <li>
                        <a href="contact-list" class="btn btn-icon btn-sm bg-white text-dark me-2" aria-label="List View"><i class="ti ti-list-tree"></i></a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    <a href="voice-call" class="btn btn-icon btn-light btn-sm" aria-label="Voice Call"><i class="ti ti-phone-calling"></i></a>
                                    <a href="chat" class="btn btn-icon btn-light btn-sm" aria-label="Chat"><i class="ti ti-message-chatbot"></i></a>
                                    <a href="video-call" class="btn btn-icon btn-light btn-sm" aria-label="Video Call"><i class="ti ti-video-plus"></i></a>
                                </div>
                                <div>
