                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="settings-wrapper d-flex">
                                ...
                                <div class="card flex-fill mb-0 shadow-none">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a class="btn btn-dark me-2" href="shift-settings"><i class="ti ti-clock me-1"></i>Shifts</a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-nowrap bg-white border mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Maternity Leave</td>
                                                        <td>21 Jul 2025</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Paternity Leave</td>
                                                        <td>15 Mar 2025</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <div>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Compensatory Off</td>
                                                        <td>18 Feb 2025</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                            <div>
