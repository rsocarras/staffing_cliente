            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                        <li class="nav-item">
                            <a href="project" class="nav-link active"><i class="ti ti-box fs-16 me-2"></i> Active</a>
                        </li>
                        <li class="nav-item">
                            <a href="project-archived" class="nav-link"><i class="ti ti-archive fs-16 me-2"></i>Archived</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <table class="table m-0 table-nowrap bg-white border">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li>
                                                <a href="project-details" class="dropdown-item"><i class="ti ti-eye me-2 "></i>View</a>
                                            </li>
                                            <li>
                                                <a href="edit-project" class="dropdown-item"><i class="ti ti-edit me-2 "></i>Edit</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-copy me-2 "></i>Clone</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-archive me-2 "></i>Archive</a>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><a href="project-details">#PRJ0017</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar online avatar-rounded">
                                    ...
                                    <td><a href="project-details" class="fw-medium">Chat & Call Mobile App</a></td>
                                    <td>
                                        <span class="badge badge-soft-orange"><i class="ti ti-flag me-1"></i>High</span>
                                    </td>
                                    <td>45h 00m</td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="project-details">#PRJ0015</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar online avatar-rounded">
                                    ...
                                    <td><a href="project-details" class="fw-medium">Service Booking Software</a></td>
                                    <td>
                                        <span class="badge badge-soft-orange"><i class="ti ti-flag me-1"></i>High</span>
                                    </td>
                                    <td>75h 18m</td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="project-details">#PRJ0013</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar online avatar-rounded">
                                    ...
                                    <td><a href="project-details" class="fw-medium">Food Order App</a></td>
                                    <td>
                                        <span class="badge badge-soft-danger"><i class="ti ti-flag me-1"></i>Medium</span>
                                    </td>
                                    <td>20h 15m</td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="project-details">#PRJ0011</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="avatar online avatar-rounded">
                                    ...
                                    <td><a href="project-details" class="fw-medium">POS Admin Software</a></td>
                                    <td>
                                        <span class="badge badge-soft-danger"><i class="ti ti-flag me-1"></i>Medium</span>
                                    </td>
                                    <td>92h 16m</td>
