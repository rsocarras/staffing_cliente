                                ...
                                <div class="card-body p-0">
                                    <div class="mail-message-view p-4" data-simplebar>
                                        <div class="d-flex align-items-center justify-content-between flex-wrap flex-xl-nowrap row-gap-2 mb-3">
                                            <h6 class="mb-0">Subject : Modernize Your Practice with Our All-in-One Dreams Timer Solution</h6>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3 border-bottom flex-wrap flex-md-nowrap row-gap-2 pb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="#" class="btn btn-icon btn-sm btn-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Starred"><i class="ti ti-star"></i></a>
                                                ...
                                                <a href="#" class="btn btn-icon btn-sm btn-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Reply"><i class="ti ti-arrow-back-up"></i></a>
                                            </div>
                                        </div>
                                        <div>
                                            <h6 class="fs-16 fw-medium mb-2">Hi Adrian</h6>
