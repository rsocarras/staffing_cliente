                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_shift"><i class="ti ti-plus me-1"></i>Add New</a>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit_shift"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                </li>
                                                                <li>
