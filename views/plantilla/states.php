                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-4">
                        <div class="flex-grow-1">
                            <h4 class="fs-20 fw-bold mb-0">States</h4>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <a href="#" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#add_states"><i class="ti ti-plus me-1"></i>Add New</a>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table table-nowrap bg-white border mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">California</div>
                                    </td>
                                    <td>United States</td>
                                    <td>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit_states"><i class="ti ti-edit me-1"></i>Edit</a>
                                                </li>
                                                <li>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">Texas</div>
                                    </td>
                                    <td>United States</td>
                                    <td>
                                        <span class="badge badge-soft-success">Active</span>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">Bavaria</div>
                                    </td>
                                    <td>Germany</td>
                                    <td>
                                        <span class="badge badge-soft-success">Active</span>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">Quebec</div>
                                    </td>
                                    <td>Canada</td>
                                    <td>
                                        <span class="badge badge-soft-success">Active</span>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">Ontario</div>
                                    </td>
                                    <td>Canada</td>
                                    <td>
                                        <span class="badge badge-soft-success">Active</span>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">Florida</div>
                                    </td>
                                    <td>United States</td>
                                    <td>
                                        <span class="badge badge-soft-success">Active</span>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">Berlin</div>
                                    </td>
                                    <td>Germany</td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">Victoria</div>
                                    </td>
                                    <td>Australia</td>
                                    <td>
                                        <span class="badge badge-soft-success">Active</span>
                                ...
                                <tr>
                                    <td>
                                        <div class="fw-medium text-dark">Gauteng</div>
                                    </td>
                                    <td>Egypt</td>
                                    <td>
                                        <span class="badge badge-soft-success">Active</span>
