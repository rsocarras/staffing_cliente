            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                        ...
                        <li class="nav-item">
                            <a href="tasks-onhold" class="nav-link active">
                        ...
                        <table class="table mb-0 table-nowrap bg-white border">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item"><i class="ti ti-refresh me-2"></i>Restore Task</a>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-soft-info text-info"><i class="ti ti-flag-filled"></i> Medium</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="project-details" class="text-primary">#TAS23169</a>
                                    </td>
                                    <td>
