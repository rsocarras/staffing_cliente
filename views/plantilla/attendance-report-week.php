            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <!-- Tabs -->
                        ...
                        <li class="nav-item">
                            <a href="attendance-report-week" class="nav-link d-flex align-items-center active"><i class="ti ti-calendar me-2"></i>By Week</a>
                        </li>
                        <li class="nav-item">
                            <a href="attendance-report-month" class="nav-link d-flex align-items-center"><i class="ti ti-calendar me-2"></i>By Month</a>
                        </li>
                    </ul>  
