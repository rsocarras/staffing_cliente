                                ...
                                <div class="card flex-fill mb-0 bg-soft-light border shadow-none">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                                            <li class="nav-item">
                                                <a href="expense-category-settings" class="nav-link">
                                                    <span class="d-md-inline-block">Expense Category</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="expense-type-settings" class="nav-link active">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-expense-type"><i class="ti ti-plus me-1"></i>Add New</a>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-nowrap bg-white border mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Rental</p></td>
                                                        <td>Travel</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit-expense-type"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#delete-expense-type"><i class="ti ti-trash me-2"></i>Delete</a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Reservation</p></td>
                                                        <td>Travel</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                    ...
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Flight Travel</p></td>
                                                        <td>Travel</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                    ...
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Promotion</p></td>
                                                        <td>Advertising</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                    ...
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Stationery</p></td>
                                                    ...
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Cleaning Supplies</p></td>
                                                        <td>Office Supplies</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                    ...
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Chairs & Tables</p></td>
                                                        <td>Office Supplies</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                    ...
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Electricity</p></td>
                                                        <td>Utilities</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
                                                    ...
                                                    <tr>
                                                        <td><p class="fw-medium text-dark mb-0">Water Supply</p></td>
                                                        <td>Utilities</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                            <button class="dropdown-toggle drop-arrow-none btn-icon btn-sm btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Actions">
