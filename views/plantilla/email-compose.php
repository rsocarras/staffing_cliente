                ...
                <div class="card-body p-0">
                    ...
                    <div class="row g-0">
                                        ...
                                        <div class="accordion-item mb-3 pb-3">
                                            ...
                                            <div id="flush-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                                                <div class="nav flex-column mt-2">
                                                    <a href="email" class="d-flex text-start align-items-center fw-medium fs-14 rounded p-2 mb-1"><i class="ti ti-inbox me-2"></i>Inbox<span class="avatar avatar-xs ms-auto bg-danger rounded-circle">6</span></a>
                        ...
                        <div class="col-lg-9 col-md-8">
                            <!-- card start -->
                            <div class="card border-0 mb-0 rounded-0 custom-left-border shadow-none">
                                    ...
                                    <div class="mail-messages p-4" data-simplebar>
                                        <form action="email-compose">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Bcc <span class="text-danger ms-1">*</span></label>
                                                        <select class="select">
                                                            <option>Select</option>
