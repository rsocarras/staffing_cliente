                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-4">
                        <div class="flex-grow-1">
                            <h4 class="fs-20 fw-bold mb-0">Attendance Report</h4>
                        </div>
                        <div class="text-end">
                    ...
                    <!-- Tabs -->
                        ...
                        <li class="nav-item">                                             
                            <a href="attendance-report" class="nav-link d-flex align-items-center"><i class="ti ti-calendar me-2"></i>By Day</a>
                        </li>
                        <li class="nav-item">
                            <a href="attendance-report-week" class="nav-link d-flex align-items-center"><i class="ti ti-calendar me-2"></i>By Week</a>
                        </li>
                        <li class="nav-item">
                            <a href="attendance-report-month" class="nav-link d-flex align-items-center active"><i class="ti ti-calendar me-2"></i>By Month</a>
                        </li>
                    </ul>   
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                                Show only absent or late shifts
                            </label>
                        </div>
                    </div>
                        ...
                        <table class="table m-0 table-nowrap bg-white border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>01h 10m</td>
                                    <td>
                                        <span class="badge bg-warning">Partially Worked</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
