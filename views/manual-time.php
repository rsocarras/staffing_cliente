            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                        <li class="nav-item">                                             
                            <a href="manual-time" class="nav-link d-flex align-items-center active"><i class="ti ti-clock me-2"></i>Manual Time Report Day</a>
                        </li>
                        <li class="nav-item">
                            <a href="manual-time-week" class="nav-link d-flex align-items-center"><i class="ti ti-clock me-2"></i>Manual Time Report Week</a>
                        </li>
                    </ul>
