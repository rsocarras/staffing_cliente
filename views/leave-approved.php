            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                        ...
                        <li class="nav-item">
                            <a href="leave-approved" class="nav-link active">
                        ...
                        <table class="table table-nowrap bg-white border mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>20 Apr 2025</td>
                                    <td>1 Day</td>
                                    <td><a class="link-reset fs-20 p-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#view-approved"><i class="ti ti-file-text"></i></a></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
