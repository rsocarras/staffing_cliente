...
$createAjaxUrl = Url::to(['contabilidad-centro-costo/create-ajax']);
$baseViewUrl = Url::to(['contabilidad-centro-costo/view']);
$baseUpdateUrl = Url::to(['contabilidad-centro-costo/update']);
$baseDeleteUrl = Url::to(['contabilidad-centro-costo/delete']);
?>
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
                    <div class="input-group w-auto input-group-flat">
                        ...
                        <input type="text" class="form-control form-control-sm" id="centro-costo-search" placeholder="Buscar...">
                    </div>
                    <div class="d-flex align-items-center gap-3 flex-wrap">
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_centro_costo"><i class="ti ti-plus me-1"></i>Agregar</a>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-nowrap bg-white border mb-0" id="contabilidad-centro-costo-table">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Código</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="centro-costo-form-errors" class="alert alert-danger d-none"></div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btn-save-centro-costo">
...
$(document).ready(function() {
    ...
    $('#centro-costo-search').on('keyup', function() {
        table.search(this.value).draw();
    });

    $('#form-add-centro-costo').on('submit', function(e) {
        e.preventDefault();
        var \$form = $(this);
        var \$btn = $('#btn-save-centro-costo');
        var \$errors = $('#centro-costo-form-errors');
        ...
        if (!\$('#centro-costo-activo').is(':checked')) {
            formData += '&ContabilidadCentroCosto[activo]=0';
        }
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.success) {
                    var modal = bootstrap.Modal.getInstance(document.getElementById('add_centro_costo'));
                    modal.hide();
                    \$form[0].reset();
                    $('#centro-costo-activo').prop('checked', true);
    ...
    $('#add_centro_costo').on('hidden.bs.modal', function() {
        $('#form-add-centro-costo')[0].reset();
        $('#centro-costo-activo').prop('checked', true);
        $('#centro-costo-form-errors').addClass('d-none').empty();
    });
});
JS;
