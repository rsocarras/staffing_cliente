                        ...
                        <div class="card mb-0 flex-fill shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="avatar avatar-lg rounded-circle bg-dark flex-shrink-0 me-3">
                                    <span class="avatar-title text-white"><i class="ti ti-git-branch fs-22"></i></span>
                                </div>
                                <div>
                        ...
                        <div class="card mb-0 flex-fill shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="avatar avatar-lg rounded-circle bg-warning flex-shrink-0 me-3">
                                    <span class="avatar-title text-dark"><i class="ti ti-file-pencil fs-22"></i></span>
                                </div>
                                <div>
...
<div class="modal fade" id="modal-view-novedad-flujo">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content position-relative">
            ...
            <div class="modal-body" id="modal-view-novedad-flujo-body">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-novedad-flujo-view', function() {
        ...
        $('#modal-view-novedad-flujo-body').html('<div class="text-center py-4"><span class="spinner-border text-primary"></span></div>');
        modal.show();
        $.get('{$viewAjaxUrl}', { id: id }, function(html) {
            $('#modal-view-novedad-flujo-body').html(html);
        }).fail(function() {
            $('#modal-view-novedad-flujo-body').html('<div class="alert alert-danger">Error al cargar los datos.</div>');
        });
    });
