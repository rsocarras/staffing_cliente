                        ...
                        <div class="chat-user-nav">
                            <div>
                                <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                    ...
                                    <a href="#" class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="New Chat"><i class="ti ti-plus"></i></a>
                                </div>
                                <div>
                                    ...
                                    <div class="chat-users p-4" data-simplebar>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                                            ...
                                            <div class="text-end">
                                                <span class="text-dark d-block mb-1">yesterday</span>
                                                <span class="d-blockAndrew Fletcher"><i class="ti ti-checks"></i></span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                                            <div class="d-flex align-items-center">
                            ...
                            <div class="card border-0 mb-0">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-3">
                                    ...
                                    <div class="gap-2 d-flex align-items-center flex-wrap">
                                        <a href="voice-call" class="btn btn-icon btn-light btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh" data-bs-original-title="Voice Call"><i class="ti ti-phone"></i></a>
                                        <a href="video-call" class="btn btn-icon btn-light btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh" data-bs-original-title="Video Call"><i class="ti ti-video"></i></a>
                                        <a href="javascript:void(0);" class="btn btn-icon btn-light btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh" data-bs-original-title="Info"><i class="ti ti-info-circle"></i></a>
                                        <a href="javascript:void(0);" class="btn btn-icon btn-light btn-sm close-chat d-md-none"><i class="ti ti-x"></i></a>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-2">
                                                        <button type="button" class="btn btn-ghost p-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="Message options">
