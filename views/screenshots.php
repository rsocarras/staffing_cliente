                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-4">
                        <div class="flex-grow-1">
                            <h4 class="fs-20 fw-bold mb-0">Screenshots</h4>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            ...
                            <span class="d-flex align-items-center"><i class="ti ti-calendar me-1 text-dark"></i>05 Jan 2025</span>
                        </div>
                    ...
                    <div class="row row-cols-xl-4 row-cols-sm-2 row-cols-1 justify-content-center">
                        ...
                        <div class="col">
                            <div class="card screenshot-item shadow-none mb-0">
                                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between pt-4 mt-4 mb-4 border-top">
                        <div>
                            <h6 class="fw-medium mb-1">08:00 AM - 09:00 AM</h6>
