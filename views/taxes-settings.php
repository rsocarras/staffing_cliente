                                ...
                                <div class="card flex-fill mb-0 bg-soft-light border shadow-none">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                                            ...
                                            <li class="nav-item">
                                                <a href="taxes-settings" class="nav-link active">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-tax"><i class="ti ti-plus me-1"></i>Add New</a>
                                        </div>
                                        ...
                                        <div class="table-responsive mb-4">
                                            <table class="table table-nowrap bg-white border mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-medium text-dark">VAT</td>
                                                        <td>10%</td>
                                                        <td>24 Jan 2025</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit-tax"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#delete-tax"><i class="ti ti-trash me-2"></i>Delete</a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="fw-medium text-dark">CGST</td>
                                                        <td>08%</td>
                                                        <td>20 Jan 2025</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">SGST</td>
                                                        <td>10%</td>
                                                        <td>15 Jan 2025</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            <h6 class="mb-0 ">Tax Group </h6>
                                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-tax-group"><i class="ti ti-plus me-1"></i>Add New</a>
                                        </div>
                                        ...
                                        <div class="table-responsive mb-4">
                                            <table class="table table-nowrap bg-white border mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-medium text-dark">GST</td>
                                                        <td>18%</td>
                                                        <td>24 Jan 2025</td>
                                                        <td><span class="badge bg-soft-success">Active</span></td>
                                                        <td>
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit-tax-group"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                </li>
                                                                <li>
                                                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#delete-tax"><i class="ti ti-trash me-2"></i>Delete</a>
                                                                </li>
