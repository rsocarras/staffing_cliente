            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                        ...
                        <li class="nav-item">
                            <a href="edit-time-approved" class="nav-link active">
                    ...
                    <!-- Start Search and Filter -->
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
                        <h6 class="fw-bold mb-0">Approved Edit Time</h6>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="d-block">Components Creation</span>
                                    </td>
                                    <td>
                                        24 Dec 2025
                                    </td>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" class="link-reset fs-18" data-bs-toggle="modal" data-bs-target="#view-approved"><i class="ti ti-file-text fs-18"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="project-details" class="fw-medium">Travel Planning Website</a>
                                        <span class="d-block">New Pages Design</span>
                                    </td>
                                    <td>
                                        10 Sep 2025
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="d-flex">Components Creation</span>
                                    </td>
                                    <td>
                                        14 Oct 2025
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="project-details" class="fw-medium">POS Admin Software</a>
                                        <span class="d-block">Landing Page</span>
                                    </td>
                                    <td>
                                        10 Dec 2025
                                    </td>
