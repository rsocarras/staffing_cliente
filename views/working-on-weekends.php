                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-4">
                        <div class="flex-grow-1">
                            <h4 class="fs-20 fw-bold mb-0">Working on Weekends</h4>
                        </div>
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                <li class="breadcrumb-item"><a href="index">Home</a></li>       
                                <li class="breadcrumb-item"><a href="reports">Report</a></li>                         
                                <li class="breadcrumb-item active" aria-current="page">Working on Weekends</li>
                            </ol>
                        </div>
                    </div>
                    <!-- End Page Header -->
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="#" class="nav-link d-flex align-items-center active bg-transparent" id="info-tab" data-bs-toggle="tab" data-bs-target="#employee" role="tab" aria-selected="true"><i class="ti ti-user me-2"></i> By Employee</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="#" class="nav-link d-flex align-items-center bg-transparent" id="date-tab" data-bs-toggle="tab" data-bs-target="#date" role="tab" aria-selected="false"><i class="ti ti-calendar me-2"></i>By Date</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="#" class="nav-link d-flex align-items-center bg-transparent" id="team-tab" data-bs-toggle="tab" data-bs-target="#team" role="tab" aria-selected="false"><i class="ti ti-users-group me-2"></i>By Team</a>
                        </li>
                    </ul>  
                            ...
                            <div class="table-responsive">
                                <table class="table m-0 table-nowrap bg-white border">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse" data-bs-toggle="collapse" data-bs-target=".task-collapse-content" aria-expanded="false">13 Jan 2025 <i class="ti ti-chevron-up ms-2"></i></a></h6>
                                            </td>
                                        ...
                                        <tr class="task-collapse-content collapse">
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse text-gray" data-bs-toggle="collapse" data-bs-target=".task-collapse-content" aria-expanded="false">Shaun Farley</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>01h 40m</td>
                                        ...
                                        <tr class="task-collapse-content collapse">
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse text-gray" data-bs-toggle="collapse" data-bs-target=".task-collapse-content" aria-expanded="false">Jenny Ellis</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>01h 30m</td>
                                        ...
                                        <tr class="task-collapse-content collapse">
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse text-gray" data-bs-toggle="collapse" data-bs-target=".task-collapse-content" aria-expanded="false">Leon Baxter</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>01h 20m</td>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse" data-bs-toggle="collapse" data-bs-target=".task2-collapse-content" aria-expanded="false">14 Jan 2025 <i class="ti ti-chevron-up ms-2"></i></a></h6>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse" data-bs-toggle="collapse" data-bs-target=".task3-collapse-content" aria-expanded="false">15 Jan 2025 <i class="ti ti-chevron-up ms-2"></i></a></h6>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse" data-bs-toggle="collapse" data-bs-target=".task4-collapse-content" aria-expanded="false">16 Jan 2025 <i class="ti ti-chevron-up ms-2"></i></a></h6>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse" data-bs-toggle="collapse" data-bs-target=".task5-collapse-content" aria-expanded="false">17 Jan 2025 <i class="ti ti-chevron-up ms-2"></i></a></h6>
                                            </td>
                                            <td class="text-dark">04h 10m</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <h6 class="fw-medium mb-0 fs-14"><a href="#" class="d-flex align-items-center collapsed task-collapse" data-bs-toggle="collapse" data-bs-target=".task6-collapse-content" aria-expanded="false">18 Jan 2025 <i class="ti ti-chevron-up ms-2"></i></a></h6>
                                            </td>
