            ...
            <div class="card shadow-none mb-0">
                <div class="card-body p-0">
                    ...
                    <div class="row g-0">
                            ...
                            <div class="p-4 pb-2 pb-sm-4 mail-sidebar" data-simplebar>
                                <div>
                                    <div class="mb-3">
                                        <a href="email-compose" class="btn btn-primary w-100"><i class="ti ti-square-rounded-plus me-1"></i>Compose New</a>
                                    </div>
                                        ...
                                        <div class="accordion-item mb-3 pb-3">
                                            ...
                                            <div id="flush-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                                                <div class="nav flex-column mt-2">
                                                    <a href="email" class="d-flex text-start align-items-center fw-medium fs-14 bg-light rounded p-2 mb-1"><i class="ti ti-inbox me-2"></i>Inbox<span class="avatar avatar-xs ms-auto bg-danger rounded-circle">6</span></a>
                            ...
                            <div class="card border-0 rounded-0 custom-left-border mb-0">
                                ...
                                <div class="card-header d-flex align-items-center flex-wrap gap-2 justify-content-between px-3">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="#" class="btn btn-icon btn-sm btn-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Archive"><i class="ti ti-archive"></i></a>
                                            <a href="#" class="btn btn-icon btn-sm btn-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete"><i class="ti ti-trash"></i></a>
                                            <a href="#" class="btn btn-icon btn-sm btn-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Report Spam"><i class="ti ti-message-report"></i></a>
                                            <div>
                                            ...
                                            <table class="table border-0 w-100">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 mb-1"><a href="email-details">[Reminder] Client Meeting at 3 PM Today</a></h6>
                                                                <p class="text-truncate mb-0">Hi John, just a quick reminder about our meeting with ABC Corp at 3 PM...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 mb-1"><a href="email-details">Submit Project Proposal</a></h6>
                                                                <p class="text-truncate mb-0">Hi Team, please ensure that your sections of the project proposal are sub...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 d-flex fw-normal align-items-center mb-1"><a href="email-details">Team Outing Next Friday</a><span class="badge bg-info ms-2">Marketing</span></h6>
                                                                <p class="text-truncate mb-0">Hello Everyone, we’re planning a team outing next Friday. Please RSVP by...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 d-flex align-items-center mb-1"><a href="email-details">[Update] New Design Guidelines Available</a><span class="badge bg-warning ms-2">Client</span></h6>
                                                                <p class="text-truncate mb-0">Hi all, the new design guidelines have been finalized and are now available...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 fw-normal mb-1"><a href="email-details">[Event] Webinar on Social Media Strategy</a></h6>
                                                                <p class="text-truncate mb-0">Don’t forget to register for our webinar covering advanced social media stra...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 mb-1"><a href="email-details">[Reminder] Sales Targets Review</a></h6>
                                                                <p class="text-truncate mb-0">Hey Team, please prepare your sales reports for the review meeting schedul...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 fw-normal d-flex align-items-center mb-1"><a href="email-details">[Alert] System Maintenance Scheduled</a><span class="badge bg-success ms-2">Personal</span></h6>
                                                                <p class="text-truncate mb-0">Dear Team, please be aware that there will be system maintenance this Satu...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 mb-1"><a href="email-details">Expense Reports Due</a></h6>
                                                                <p class="text-truncate mb-0">Hi everyone, please submit all expense reports for Q3 by the end of this week...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 fw-normal mb-1"><a href="email-details">Beta Testing</a></h6>
                                                                <p class="text-truncate mb-0">Hi Team, your feedback on the latest beta release is crucial. Please complete...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 fw-normal mb-1"><a href="email-details">[Reminder] Contract Renewals</a></h6>
                                                                <p class="text-truncate mb-0">Attention all, please ensure that all contract renewals are reviewed and...</p>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="email-content overflow-hidden">
                                                                <h6 class="text-truncate fs-14 fw-normal mb-1"><a href="email-details">[Notice] Policy Changes</a></h6>
                                                                <p class="text-truncate mb-0">Hello Team, we have implemented some policy changes effective immediately...</p>
                                                            </div>
                                                        </td>
