...
<div class="sede-category-modal-form">
    ...
    <div class="rounded-3 border border-dashed p-3 p-md-4 mb-3 bg-light">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <?= $form->field($model, 'valor_hora_base')->textInput(['type' => 'number', 'step' => '0.0001', 'min' => '0', 'inputmode' => 'decimal', 'placeholder' => '0.0000']) ?>
            </div>
            <div class="col-md-6">
                <?= $form->field($model, 'valor_hora_domingo_festivos')->textInput(['type' => 'number', 'step' => '0.0001', 'min' => '0', 'inputmode' => 'decimal', 'placeholder' => '0.0000']) ?>
            </div>
            <div class="col-md-6">
                <?= $form->field($model, 'valor_hora_nocturna')->textInput(['type' => 'number', 'step' => '0.0001', 'min' => '0', 'inputmode' => 'decimal', 'placeholder' => '0.0000']) ?>
            </div>
            <div class="col-md-6">
                <?= $form->field($model, 'valor_hora_nocturna_festiva')->textInput(['type' => 'number', 'step' => '0.0001', 'min' => '0', 'inputmode' => 'decimal', 'placeholder' => '0.0000']) ?>
            </div>
            <div class="col-md-6">
