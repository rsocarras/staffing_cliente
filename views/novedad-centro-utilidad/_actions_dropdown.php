...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end">
        <?php if (!empty($puedeVer)): ?>
            <li>
                <a href="javascript:void(0);" class="dropdown-item btn-ncu-view d-flex align-items-center gap-2 py-2 rounded text-info" data-id="<?= $model->id ?>">
        ...
        <?php if (!empty($puedeEditar)): ?>
            <li>
                <a href="javascript:void(0);" class="dropdown-item btn-ncu-edit d-flex align-items-center gap-2 py-2 rounded" data-id="<?= $model->id ?>">
        ...
        <?php if (!empty($puedeEliminar)): ?>
            <li>
                <a href="javascript:void(0);" class="dropdown-item text-danger btn-ncu-delete d-flex align-items-center gap-2 py-2 rounded" data-id="<?= $model->id ?>" data-nombre="<?= Html::encode($model->nombre) ?>">
