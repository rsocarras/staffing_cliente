                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3">
                        <div class="flex-grow-1">
                            <h4 class="fs-18 fw-semibold mb-0">Gallery</h4>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- start row -->
                            <div class="row gy-3 align-items-center text-center justify-content-center">
                    ...
                    <div class="card mb-0">
                        <div class="card-header">
                            <h5 class="mb-0">Image with Decsription</h5>
                        </div>
                        <div class="card-body">
