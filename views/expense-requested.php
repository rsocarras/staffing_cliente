            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                        <li class="nav-item">
                            <a href="expense-requested" class="nav-link active">
                        ...
                        <table class="table m-0 table-nowrap bg-white border">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>15 May 2025</td>
                                    <td>15 May 2025</td>
                                    <td><a href="project-details">Doccure</a></td>
                                    <td>USD</td>
                                    <td>5000</td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="javascript:void(0);" class="d-inline-flex btn btn-icon btn-sm btn-outline-light text-primary rounded-pill fs-16" data-bs-toggle="modal" data-bs-target="#expense-accept-modal"><i class="ti ti-check"></i></a>
                                            <a href="javascript:void(0);" class="d-inline-flex btn btn-icon btn-sm btn-outline-light text-danger rounded-pill fs-16" data-bs-toggle="modal" data-bs-target="#expense-reject-modal"><i class="ti ti-x"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>13 May 2025</td>
                                    <td>13 May 2025</td>
                                    <td><a href="project-details">Tour & Travel</a></td>
                                    <td>Euro</td>
                                    <td>1459</td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                ...
                                <tr>
                                    ...
                                    <td>11 May 2025</td>
                                    <td>11 May 2025</td>
                                    <td><a href="project-details">CSPSC</a></td>
                                    <td>Dhirams</td>
                                    <td>6589</td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                ...
                                <tr>
                                    ...
                                    <td>26 Apr 2025</td>
                                    <td>26 Apr 2025</td>
                                    <td><a href="project-details">Law Maker</a></td>
                                    <td>Euro</td>
                                    <td>4754</td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                ...
                                <tr>
                                    ...
                                    <td>16 Feb 2025</td>
                                    <td>16 Feb 2025</td>
                                    <td><a href="project-details">Booking App Mobile</a></td>
                                    <td>USD</td>
                                    <td>3659</td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
