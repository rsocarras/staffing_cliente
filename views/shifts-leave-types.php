                                ...
                                <div class="card flex-fill mb-0 bg-soft-light shadow-none border">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4">
                                            ...
                                            <li class="nav-item">
                                                <a href="shift-settings" class="nav-link active">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                            <h6 class="fw-bold mb-0">Shifts & Leave Types</h6>
                                            <div class="d-flex align-items-center">
                                                <a class="btn btn-dark me-2" href="leave-types"><i class="ti ti-polygon me-1"></i>Leave type</a>
                                                <a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#add_shift"><i class="ti ti-plus me-1"></i>Add New</a>
                                            </div>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-nowrap bg-white border mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-medium text-dark">Regular Shift</td>
                                                        <td>09:30 AM</td>
                                                        <td>06:30 PM</td>
                                                        ...
                                                        <td>
                                                            <div>
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right">
                                                                    <li>
                                                                        <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit_department"><i class="ti ti-edit me-2"></i>Edit</a>
                                                                    </li>
                                                                    <li>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Morning Shift</td>
                                                        <td>09:30 PM</td>
                                                        <td>01:30 PM</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Evening Shift</td>
                                                        <td>02:30 PM</td>
                                                        <td>12:30 AM</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Night Shift</td>
                                                        <td>09:30 PM</td>
                                                        <td>06:30 AM</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Mid Shift</td>
                                                        <td>04:30 PM</td>
                                                        <td>11:30 PM</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="fw-medium text-dark">Weekend Shift</td>
                                                        <td>09:30 PM</td>
                                                        <td>06:30 AM</td>
                                                        <td><span class="badge badge-soft-success">Active</span></td>
                                                        <td>
