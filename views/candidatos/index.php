                        ...
                        <div class="card mb-0 flex-fill shadow-sm">
                            <div class="card-body d-flex align-items-center">
                                <div class="avatar avatar-lg rounded-circle bg-danger flex-shrink-0 me-3">
                                    <span class="avatar-title text-white"><i class="ti ti-user-x fs-22"></i></span>
                                </div>
                                <div>
...
<div class="modal fade" id="modal-view-candidato">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content position-relative">
            ...
            <div class="modal-body" id="modal-view-candidato-body">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-candidato-view', function() {
        ...
        $('#modal-view-candidato-body').html('<div class="text-center py-4"><span class="spinner-border text-primary"></span></div>');
        modal.show();
        $.get('{$viewAjaxUrl}', { id: id }, function(html) {
            $('#modal-view-candidato-body').html(html);
        }).fail(function() {
            $('#modal-view-candidato-body').html('<div class="alert alert-danger">Error al cargar los datos.</div>');
        });
    });
