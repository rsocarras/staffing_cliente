            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                        <li class="nav-item">
                            <a href="timeline-details" class="nav-link active"><i class="ti ti-photo fs-13 me-1"></i> Screenshots</a>
                        </li>
                        <li class="nav-item">
                            <a href="usage-timeline-details" class="nav-link"><i class="ti ti-chart-pie fs-13 me-1"></i>Usage</a>
                        </li>
                    </ul>
                    <!-- End Tab -->
                    ...
                    <div class="row row-cols-xl-4 row-cols-sm-2 row-cols-1 justify-content-center">
                        <div class="col">
                            <div class="card screenshot-item shadow-none mb-lg-0">
                                <div class="card-body">
                                    ...
                                    <div class="card-img rounded-2 border mb-2">
                                        ...
                                        <div class="download-delete-icon">
                                            ...
                                            <a href="javascript:void(0);" class="delete-icon d-inline-flex justify-content-center align-items-center rounded-circle"><i class="ti ti-trash fs-13"></i></a>
                                        </div>
                                    </div>
                        ...
                        <div class="col">
                            <div class="card screenshot-item shadow-none m-0">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div class="d-flex align-items-center">
