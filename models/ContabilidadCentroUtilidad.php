...
/**
 * This is the model class for table "contabilidad_centro_utilidad".
 *
 * @property int $id
 ...
 */
class ContabilidadCentroUtilidad extends \yii\db\ActiveRecord
{
    ...
    {
        return 'contabilidad_centro_utilidad';
    }
    ...
    {
        return $this->hasMany(EmpleadoVenueHistory::class, ['centro_utilidad_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(MallaDistribucionHoras::class, ['centro_utilidad_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Profile::class, ['centro_utilidad_id' => 'id']);
    }
