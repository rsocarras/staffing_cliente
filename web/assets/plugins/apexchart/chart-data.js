...
if ($('#hours-chart').length > 0) {
const options = {
    series: [{
      labels: ['Hours'],
      data: [70, 80, 85, 90, 98, 100, 105, 110, 130]
    }],
    chart: {
      height: 37,
      width: 60,
  ...
  const chart = new ApexCharts(document.querySelector("#hours-chart"), options);
  chart.render();
}

if ($('#productive-hour').length > 0) {
const options = {
    series: [{
      labels: ['Hours'],
      data: [90, 80, 67, 87, 98, 79, 105, 100, 130]
    }],
    chart: {
      height: 37,
      width: 60,
  ...
  const chart = new ApexCharts(document.querySelector("#productive-hour"), options);
  chart.render();
}

if ($('#unproductive-hour').length > 0) {
const options = {
    series: [{
      labels: ['Hours'],
      data: [80, 70, 85, 95, 98, 90, 105, 80, 130]
    }],
    chart: {
      height: 37,
      width: 60,
  ...
  const chart = new ApexCharts(document.querySelector("#unproductive-hour"), options);
  chart.render();
}

if ($('#manual-hour').length > 0) {
const options = {
    series: [{
      labels: ['Hours'],
      data: [70, 90, 85, 100, 98, 110, 105, 120, 130]
    }],
    chart: {
      height: 37,
      width: 60,
  ...
  const chart = new ApexCharts(document.querySelector("#manual-hour"), options);
  chart.render();
}