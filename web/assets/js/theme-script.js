// === Early theme init (must be first in file) ===
(function() {
  const root = document.documentElement;
	try {
		...
		if (config && config.theme) {
			root.setAttribute("data-bs-theme", config.theme);
		}
		} else {
		root.setAttribute("data-bs-theme", "light"); // default
		}
	} catch (e) {
...
// 🔹 Reusable Theme Switch Method
	// 🔹 Reusable Theme Switch Method with controlled transition
switchTheme() {
  ...
  // Force reflow (ensures the browser registers the class before theme swap)
  ...
  // Keep the class for a bit so you can actually SEE it in DevTools
  setTimeout(() => {
    html.classList.remove("no-theme-transition");
  }, 300); // delay long enough to confirm in inspector
}
	...
	initSwitchListener() {
		...
		// 🔹 Updated Light/Dark Switch
		var themeSwitchBtn = document.getElementById("light-dark-mode");
			if (themeSwitchBtn) {
			themeSwitchBtn.addEventListener("click", function() {
				a.switchTheme();
			});
		}
		var e = document.querySelector("#reset-layout");
		e && e.addEventListener("click", function(e) {
			a.resetTheme()
		});

		var sidebarToggle = document.querySelector(".sidenav-toggle-button");
		...
		var sidebarClose = document.querySelector(".button-close-fullsidebar");
...
document.addEventListener("DOMContentLoaded", function(e) {
	...
	<div class="sidebar-themesettings offcanvas offcanvas-end" tabindex="-1" id="theme-settings-offcanvas">
        <div class="d-flex align-items-center gap-2 px-3 py-3 offcanvas-header border-bottom bg-primary">
            ...
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"><i class="ti ti-circle-x"></i></button>
        </div>
                        	...
                        	<div class="theme-content">
								...
								<div class="d-flex align-items-center flex-wrap">
									...
									<div class="theme-colorselect m-1 me-2">
										...
										<label for="sidebar5Sidebar" class="d-block rounded bg-orange mb-2">
											<span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
										</label>
									</div>
									<div class="theme-colorselect m-1 me-2">
									...
									<div class="theme-colorselect m-1 me-2">
										...
										<label for="sidebar7Sidebar" class="d-block rounded bg-purple mb-2">
											<span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
										</label>
									</div>
								</div>
								...
								<div class="d-flex align-items-center flex-wrap">
									...
									<div class="theme-colorselect m-1 me-2">
										...
										<label for="gradientsidebar2Sidebar" class="d-block rounded bg-indigo-gradient">
											<span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
										</label>
									</div>
									<div class="theme-colorselect m-1 me-2">
										<input type="radio" name="data-sidebar" id="gradientsidebar3Sidebar" value="gradientsidebar3">
										<label for="gradientsidebar3Sidebar" class="d-block rounded bg-pink-gradient">
											<span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
										</label>
									</div>
									<div class="theme-colorselect m-1 me-2">
									...
									<div class="theme-colorselect m-1 me-2">
										...
										<label for="gradientsidebar5Sidebar" class="d-block rounded bg-info-gradient">
											<span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
										</label>
									</div>
									<div class="theme-colorselect m-1 me-2">
										<input type="radio" name="data-sidebar" id="gradientsidebar6Sidebar" value="gradientsidebar6">
										<label for="gradientsidebar6Sidebar" class="d-block rounded bg-danger-gradient">
											<span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
										</label>
									</div>
									<div class="theme-colorselect m-1">
										<input type="radio" name="data-sidebar" id="gradientsidebar7Sidebar" value="gradientsidebar7">
										<label for="gradientsidebar7Sidebar" class="d-block rounded bg-teal-gradient">
											<span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
										</label>
									</div>
								</div>
                            ...
                            <div class="theme-content">
                                ...
                                <div class="d-flex align-items-center flex-wrap topbar-background">
                                    ...
                                    <div class="theme-colorselect mb-3 me-3">
                                        ...
                                        <label for="topbar4Topbar" class="bg-orange"><span class="theme-check rounded-circle"><i class="ti ti-check"></i></span></label>
                                    </div>
                                    <div class="theme-colorselect mb-3 me-3">
                                    ...
                                    <div class="theme-colorselect mb-3">
                                        ...
                                        <label for="topbar6Topbar" class="bg-purple"><span class="theme-check rounded-circle"><i class="ti ti-check"></i></span></label>
                                    </div>
                                </div>
                                <h6 class="fs-14 fw-medium mb-2">Gradient Colors</h6>
                                <div class="d-flex align-items-center flex-wrap topbar-background">
                                    ...
                                    <div class="theme-colorselect mb-3 me-3">
                                        ...
                                        <label for="gradienttopbar2Topbar" class="bg-indigo-gradient"><span class="theme-check rounded-circle"><i class="ti ti-check"></i></span></label>
                                    </div>
                                    <div class="theme-colorselect mb-3 me-3">
                                        <input type="radio" name="data-topbar" id="gradienttopbar3Topbar" value="gradienttopbar3">
                                        <label for="gradienttopbar3Topbar" class="bg-pink-gradient"><span class="theme-check rounded-circle"><i class="ti ti-check"></i></span></label>
                                    </div>
                                    <div class="theme-colorselect mb-3 me-3">
                                    ...
                                    <div class="theme-colorselect mb-3 me-3">
                                        ...
                                        <label for="gradienttopbar5Topbar" class="bg-info-gradient"><span class="theme-check rounded-circle"><i class="ti ti-check"></i></span></label>
                                    </div>
                                    <div class="theme-colorselect mb-3 me-3">
                                        <input type="radio" name="data-topbar" id="gradienttopbar6Topbar" value="gradienttopbar6">
                                        <label for="gradienttopbar6Topbar" class="bg-danger-gradient"><span class="theme-check rounded-circle"><i class="ti ti-check"></i></span></label>
                                    </div>
                                    <div class="theme-colorselect mb-3 me-0">
                                        <input type="radio" name="data-topbar" id="gradienttopbar7Topbar" value="gradienttopbar7">
                                        <label for="gradienttopbar7Topbar" class="bg-teal-gradient"><span class="theme-check rounded-circle"><i class="ti ti-check"></i></span></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-body pb-2">
                            <div class="theme-content">
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <div class="theme-colorsset me-2 mb-2">
                                        <input type="radio" name="data-color" id="pinkColor" value="pink">
